...
SECRET_KEY = 'django-insecure-q-uwek(^&4@0@u94x%h#-(sz*e&^hhvf3^@%&(cm+duv5zmxrm'
...
CELERY_BEAT_SCHEDULE = {
    'log-telemetry-every-hour': {
        'task': 'reports.tasks.telemetry_log_hourly',
        'schedule': crontab(minute=0, hour='*'),  # every hour on the hour
    },
}


EXTENSION_SECRET = "mydevtoken123"




SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(hours=1),  # ⏱️ 1-hour access token
